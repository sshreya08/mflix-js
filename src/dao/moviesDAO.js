...
export default class MoviesDAO {
   ...
   */
  static textSearchQuery(text, page, moviesPerPage) {
    ...
    console.log({ query, project, sort, limit, skip }, moviesPerPage, page)
   ...
   */
  static castSearchQuery(cast, page, moviesPerPage) {
   ...
   */
  static genreSearchQuery(genre, page, moviesPerPage) {
    /**
  ...
  static async getMovies({
    ...
    if (filters) {
      if ("text" in filters) {
        queryParams = this.textSearchQuery(filters["text"], page, moviesPerPage)
      } else if ("cast" in filters) {
        queryParams = this.castSearchQuery(filters["cast"], page, moviesPerPage)
      } else if ("genre" in filters) {
        queryParams = this.genreSearchQuery(
          filters["genre"],
          page,
          moviesPerPage,
        )
